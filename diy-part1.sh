...
sed -i '$a src-git packagesImmortalWrt https://github.com/AngelaCooljx/packages.git;openwrt-18.06' feeds.conf.default
sed -i '$a src-git luciImmortalWrt https://github.com/AngelaCooljx/luci-immortalwrt.git;openwrt-18.06' feeds.conf.default
